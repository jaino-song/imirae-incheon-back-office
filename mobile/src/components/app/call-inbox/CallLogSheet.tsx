...
const LOG_BASE = "mobile_call-inbox_detail-sheet_stack_detail-page_log";
  ...
  return (
    <MobileDetailPage name="call-inbox" data-component={LOG_BASE}>
      {isLoading || !record ? (
        ...
        <div className="flex flex-col gap-4 px-1 pb-6" data-component={`${LOG_BASE}_detail`}>
          <MobileDetailHeader
            data-component={`${LOG_BASE}_detail_header`}
            name="call-inbox"
          ...
          {record.processingStatus === "FAILED" && (
            <div
              ...
              data-component={`${LOG_BASE}_detail_failed-banner`}
            >
          ...
          {(record.matchedClient || record.draft) && (
            <div className="flex flex-wrap items-center gap-2" data-component={`${LOG_BASE}_detail_links`}>
