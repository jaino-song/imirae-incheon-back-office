...
export default function DocumentList({
  ...
  return (
    <div data-component="mobile_contracts_document-list" className="overflow-x-auto">
      <table data-component="mobile_contracts_document-list_table" className="w-full table-fixed">
        <thead data-component="mobile_contracts_document-list_table_header">
          <tr className="border-b border-border">
            <th className="text-center font-medium text-muted-foreground text-sm py-3">
              문서명
            </th>
        ...
        <tbody data-component="mobile_contracts_document-list_table_body">
          {documents.map((doc) => (
            <tr
              key={doc.id}
              data-component="mobile_contracts_document-list_table_body_row"
