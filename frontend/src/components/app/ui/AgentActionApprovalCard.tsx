...
export function AgentActionApprovalCard({ actionId, capability, title, summary, expiresAt, expectedRevision, risk, branchId, target, changes, provider, estimatedCost, acknowledgementToken, terminal = false, onApprove, onReject }: AgentActionApprovalCardProps) {
    ...
    return (
        <Card data-component="desktop_chat_agent-action-approval" sourceComponent="Card" className="border-amber-300 bg-amber-50 text-amber-950" aria-label="승인 대기 작업">
            <CardContent data-component="desktop_chat_agent-action-approval_content" className="flex flex-col gap-3 p-4">
