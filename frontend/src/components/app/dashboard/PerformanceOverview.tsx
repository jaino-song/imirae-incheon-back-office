...
export const PerformanceOverview = ({ metrics, title, subtitle }: PerformanceOverviewProps) => {
  return (
    <ContentPaper data-component="desktop_dashboard_performance" className="flex-[2] p-5 sm:p-6" disableAnimation>
      ...
      <div data-component="desktop_dashboard_performance_metrics" className="flex flex-col gap-5 mt-6">
        {metrics.map((metric) => (
          <div data-component="desktop_dashboard_performance_metrics_item" key={metric.label}>
